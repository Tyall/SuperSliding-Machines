...
public class RaceAI : MonoBehaviour
{
    ...
    public void LoadNetwork()
    {
        ...
        //Debug
        Debug.Log("weight: " + weights[0].ToString());
        Debug.Log("weight: " + weights[1].ToString());
        Debug.Log("weight: " + weights[2].ToString());

        Debug.Log("biases: " + biases[0].ToString());
        Debug.Log("biases: " + biases[1].ToString());
        //print parameters of created neural network to see if it matches
        //End of debug
